...
function calcMetrics(weightG, unitWeightG, totalInvoiced, totalCheckedOut, baselineUnits, baselineCheckoutCount) {
  ...
  // DR fix: inStorage subtracts unaccounted so it doesn't double-dip
...
export default function App() {
  ...
  const resetScale = async (id) => {
    ...
    await supabase.from('scales')
      .update({ baseline_units: 0, baseline_checkout_count: 0 }).eq('id', id)
      ...
      {activeTab === 'dashboard' && (
        <main className="main">
          {SCALE_IDS.map(id => {
            ...
            const {
              onShelf, inStorage, lowStock, outOfStock,
              unaccounted, hasBaseline, totalInventory,
            } = calcMetrics(
              wt, cfg.unit_weight_g || 1, totalInv, totalChk,
              cfg.baseline_units || 0, cfg.baseline_checkout_count || 0
            )
                ...
                <div className="actions">
                  ...
                  <div className="action-group">
                    ...
                    <div className="ag-row">
                      ...
                      />
                      <button className="btn btn-blue" onClick={() => addInvoice(id)}>
                        + Add Invoice
                      </button>
                    </div>
                  ...
                  <div className="action-group">
                    ...
                    <div className="ag-row">
                      ...
                      />
                      <button className="btn btn-dark" onClick={() => doCheckout(id)}>
                        Checkout
                      </button>
                    </div>
                  ...
                  <div className="action-group">
                    ...
                    <div className="ag-row">
                      ...
                      />
                      <button className="btn btn-ghost" onClick={() => submitWeight(id)}>
                        Submit
                      </button>
                    </div>
